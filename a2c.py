...
class A2C(nn.Module):
    ...
    def __init__(self, env, hidden_size=32,feature_size=16,last_size=16, gamma=.99, random_seed=None, Riemannian=False):
        """
        ...
        nn.Linear(self.in_size, hidden_size),
        nn.ReLU(),
        nn.Linear(hidden_size, feature_size, bias = False),
        nn.Linear(feature_size, last_size),
        nn.ReLU(),
